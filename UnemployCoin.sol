...
contract ERC20 is IERC20 {
    ...
    // Added the hook function as virtual so it can be overridden
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: mint zero address");
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(owner != address(0), "ERC20: approve zero owner");
        require(spender != address(0), "ERC20: approve zero spender");
